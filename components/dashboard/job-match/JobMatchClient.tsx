    ...
    <div className="space-y-8">
      ...
      <div>
        ...
        <p className="text-slate-400">
          Compare a job description with your selected CV.
        </p>
      </div>
          ...
          <div className="bg-slate-800 border border-slate-700 rounded-lg p-6 sticky top-8">
            ...
            {cvs.length > 0 ? (
              <div className="mb-4">
                ...
                <p className="text-slate-400 text-xs mt-1">
                  {selectedCVId &&
                    `Analyzed: ${new Date(
                      cvs.find((cv) => cv.id === selectedCVId)?.createdAt ?? ""
                    ).toLocaleDateString("de-DE")}`}
                </p>
              </div>
            ) : (
              <p className="text-slate-400 text-sm mb-4">
                You haven't analyzed a CV yet. Upload one on the CV Analysis
                page first.
              </p>
            )}
            ...
            <div className="space-y-3 mt-4">
              <button
                ...
                disabled={isAnalyzing || !jobDescription.trim() || cvs.length === 0}
        ...
        <div className="lg:col-span-2">
          ...
          {!matchResult && !isAnalyzing && (
            <div className="bg-slate-800 border border-dashed border-slate-600 rounded-lg p-12 text-center">
              ...
              <p className="text-slate-400">
                Select a CV and paste a job description to see how well you match
              </p>
            </div>
          )}
        </div>
